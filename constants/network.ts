...
export const BackEndNetWorkMap: {
  ...
  test3: {
    ...
    graphqlUrl:
      "http://192.168.67.99:8083/AElfIndexer_DApp/PortKeyIndexerCASchema/graphql",
  ...
  test4: {
    ...
    graphqlUrl:
      "http://192.168.67.214:8083/AElfIndexer_DApp/PortKeyIndexerCASchema/graphql",
...
export const NetworkEnv: BackEndNetworkType = process.env
